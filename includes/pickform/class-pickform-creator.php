...
*/
			...
			$field_html = apply_filters('question_bm_filter_input_field_html', $field_html);
	...
	public function field_text_multi($field_data){
            ...
            if(!empty($field_values)){
                if(is_array($field_values)){
                    ...
                    foreach($field_values as $key=>$value){
						...
						$html.= '<input class="remove-field" type="button" value="'.__('Remove',question_bm_textdomain).'" />';						
						$html.= '</div>';
            ...
            $html.= '</div>';
            $html.= '<input class="add-field" option-id="'.$field_id.'" type="button" value="'.__('Add more',question_bm_textdomain).'" />';			
            $html.= '</div>';			
	...
	public function field_file($field_data){
			...
			$html.= '<p>'.__("Drop files here",question_bm_textdomain).'</p>
						<p class="drag-drop-buttons"><input id="plupload-browse-'.$field_id.'" type="button" value="'.__("Select Files",question_bm_textdomain).'" class="button" /></p>
					  </div>
					 </div>
				  </div>
  ...
  $plupload_init = array(
    ...
    'filters'             => array(array('title' => __('Allowed Files',question_bm_textdomain), 'extensions' => 'gif,png,jpg,jpeg')),
    'multipart'           => true,
