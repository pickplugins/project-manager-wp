		...
		if ( get_post_status ( $qa_answer_question_id ) ) {
			...
			<div class="meta_section">
				...
				<p class="meta_section_body">
					...
					<a href="post.php?post=<?php echo $qa_answer_question_id; ?>&action=edit">See more</a> </p>
			</div>
			
			<?php
		} else {
			echo '<span class="red">'.__('This question is not exist any more !',PM_TEXTDOMAIN).'</span> ';
		}
