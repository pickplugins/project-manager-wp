...
if($_GET['attendance_id']){
	...
	//echo '<pre>'.var_export(date('t', $date), true).'</pre>';
	...
	$current_minute = date('i', $date);
	$current_month = date('m', $date);
	$current_month_name = date('M', $date);
            ...
            if(in_array($i, $off_days_array) || in_array($day_string, $weekend_days_array)){
                ...
                <tr class="<?php if($i%2==0) echo 'alternate';?> <?php echo $is_weekend?> <?php echo $is_off_day?>">
                    ...
                    <td>
                        ...
                        if(!empty($user_ids_array) && empty($is_weekend) && empty($is_off_day) ):
                            foreach($user_ids_array as $user_id){
