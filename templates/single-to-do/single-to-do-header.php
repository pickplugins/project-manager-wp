    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 ">
                ...
                <h3 class="section-title">To-do Status</h3>
            ...
            <div class="col-md-6 ">
                <h3 class="section-title">Notify</h3>
                ...
                <div class="add-notify">
		            ...
		            foreach($notify_user_list as $notify_user){
                        ...
                        <input type="checkbox" id="notify_user_<?php echo $notify_user; ?>"  name="notify_user[]" value="<?php echo $notify_user; ?>" />
                        <lable for="notify_user_<?php echo $notify_user; ?>">
